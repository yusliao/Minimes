...
namespace Minimes.Application.Validators.Customer;
...
public class UpdateCustomerRequestValidator : AbstractValidator<UpdateCustomerRequest>
{
    public UpdateCustomerRequestValidator()
    {
        ...
        RuleFor(x => x.Code)
            .NotEmpty().WithMessage("客户代码不能为空")
            .MaximumLength(50).WithMessage("客户代码长度不能超过50个字符")
            .Matches(@"^[a-zA-Z0-9_-]+$").WithMessage("客户代码只能包含字母、数字、下划线和连字符");
